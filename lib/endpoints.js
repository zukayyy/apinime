...
module.exports = [
    {
        group: 'Anime — ylnime.com',
        icon: '📺',
        items: [
            { m: 'GET', p: '/anime/home', d: 'Kartu anime di beranda ylnime.' },
            {
            ...
            { m: 'GET', p: '/anime/jadwal', d: 'Jadwal rilis per hari (Senin–Minggu).' },
            { m: 'GET', p: '/anime/detail?slug=black-clover', d: 'Detail seri + daftar episode (id, label, nomor).', params: { slug: 'slug seri dari kartu' } },
            {
                m: 'GET', p: '/anime/streams?slug=black-clover&ep=al-148878-1',
                d: 'Sumber video per kualitas. ⚠️ "ep" adalah ID internal dari endpoint detail, bukan nomor episode!',
